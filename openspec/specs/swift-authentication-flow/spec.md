...
The Swift SDK MUST define how its handwritten authentication surface coordinates with the generated API client and stores the resulting authenticated session.
...
The Swift SDK MUST expose Swift-native operations for requiring, applying, clearing, and invalidating authentication sessions.
