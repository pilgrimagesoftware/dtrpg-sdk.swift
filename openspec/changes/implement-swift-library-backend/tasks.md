...
- [ ] 2.1 Implement Swift SDK operations for library list/detail workflows
- [ ] 2.2 Implement session-aware error handling behavior for library operations
- [ ] 2.3 Add tests covering successful and failure behavior for library SDK operations
